    ...
    if (this.ableToInput) {
      return (
        <div className="list-input">
          ...
          <div className="list-category">
            <h4 className="list-input-title">The Title of Your List: </h4>
            <input
              type="text"
          ...
          <div className="list-category">
            <h4 className="list-input-title"> Your List's Description: </h4>
            <textarea
              type="text"
          ...
          <div className="list-category-final">
            <h4 className="list-input-title">Select One Product Group:</h4>
      ...
      return (
        <div>
          <h1 className="after-submit">
            Thank you! Your list will be reviewed as soon as possible, and we
            will reach out to you through email shortly
          </h1>
        </div>
      );
    }
